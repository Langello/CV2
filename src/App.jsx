      ...
      <header>
        <section>
          ...
          <figcaption>
            ...
            <p>Profesional proactivo con experiencia. Trabajo en equipo respondiendo a los requerimientos del cliente.</p>
          </figcaption>
        </section>
      </header>
      <main>
        ...
        <Accordion alwaysOpen>
          <Accordion.Item eventKey="experiencia" className='acordion-item'>
            ...
            <Accordion.Body>
              <ul>
                ...
                <li><b>2023 - Actualidad: Fuddy | Desarrollador backend</b></li>
                <li>Desarrollo completo de API (Node.js - GraphQL - MongoDB).</li>
          ...
          <Accordion.Item eventKey="educacion" className='acordion-item'>
            ...
            <Accordion.Body>
              <ul>
                <li>
                  <b>2023:</b> Bootcamp de Desarrollo Web Avanzado, en la UTN, Facultad Regional de Buenos Aires.
                </li>
                <li>
                ...
                <li>
                  <b>2023:</b> Argentina programa 4.0 parte 2, en UTN. Facultad Regional de Buenos Aires.
                </li>
                <li>
          ...
          <Accordion.Item eventKey="sobreMi" className='acordion-item'>
            ...
            <Accordion.Body>
              <ul className='dos-columnas'>
                <li>Desarrollo web frontend con React.js o Angular</li>
                ...
                <li>Despliegue en la nube: Githubpages, Vercel</li>
                <li>Herramientas de administración de proyectos: Trello, Slack</li>
              </ul>
            </Accordion.Body>
          </Accordion.Item>
        </Accordion>
